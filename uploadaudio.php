...
if ($_FILES['file']['error'] === UPLOAD_ERR_OK) {
	...
	$archname = preg_replace('/[\s]/', '_', $archname); // replace spaces with _
	$famname = preg_replace('/[\s]/', '_', $famname); // replace spaces with _
	$filename = preg_replace('/[^A-Za-z0-9_]/', '', $filename); //remove non-alphanumeric or _
	$archname = preg_replace('/[^A-Za-z0-9_]/', '', $archname); //remove non-alphanumeric or _
	$famname = preg_replace('/[^A-Za-z0-9_]/', '', $famname); //remove non-alphanumeric or _
